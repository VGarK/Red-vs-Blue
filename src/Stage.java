...
public class Stage {
    ...
    //I create a PhaseContext that contains the current Strategy used (Choosing Actor Strategy)
    //PhaseContext currentStrategy = new PhaseContext(ChoosingActorStrategy);
    ...
    public void paint(Graphics g, Point mouseLoc){
        ...
        grid.paintOverlay(g, cellOverlay, new Color(0f, 0f, 0f, 0.8f));
        ...
        //in here is necessary to change the way it draws the state to drawing the Strategy used 
    ...
    public void mouseClicked(int x, int y){
       ...
       I delete the Switch case and Run the ChoosingActorStrategy
       During runtime, the machine will know what Strategy to use, be it 
       ChoosingActorStrategy, SelectingNewLocationStrategy, CPUMovingStrategy, 
       SelectingMenuItemStrategy or SelectingTargetStrategy.
                ...
                if (clicked.isPresent() && actorInAction.isPresent()) {
                    ...
                    menuOverlay.add(new MenuItem("Fire", x, y, () -> {
                        ...
                        cellOverlay.remove(actorInAction.get().loc);
                            ...
                            //subMenuOverlay.add(new MenuItem("Cancel", x, y, () -> {}));
                    }));

                    menuOverlay.add(new MenuItem("Done", x, y+MenuItem.height, () -> currentState = State.ChoosingActor));
